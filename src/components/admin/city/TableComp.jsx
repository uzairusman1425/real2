            ...
            >
                ...
                {visibleRows.map((row, index) => {
                    ...
                    <TableRow key={index}>
                        ...
                        <TableCell className='font-medium border-l-2 border-r-2 py-1'  align="left"><SvgIcon className='hover:cursor-pointer' component={DeleteForeverIcon} onClick={()=>{
                          handleDeleteRequest(row.city)                          
                        }}/></TableCell>
                    </TableRow>
                    );
                })}
