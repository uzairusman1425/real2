  ...
  return (
    <div className='static'>
      ...
      <div className='relative w-screen bg-[#f6f8f5]'>
        ...
        <div>
          <Image src={wave} alt="wave" width={Fullscreen} className='absolute -top-24 z-10 min-w-[100vw] ' style={{transform:"scale(-1,1)",fill:"black",color: "black"}} />
          <Image src={wave2} alt="wave" width={Fullscreen} className='absolute -top-24 z-20 right-0 min-w-[100vw] ' style={{opacity:"0.4",fill:"black",color: "black",translate:"translateX(1000px)"}} />
          <Image src={wave2} alt="wave" width={Fullscreen} className='absolute -top-24 z-20 right-0 min-w-[100vw]  ' style={{opacity:"0.4",fill:"black",color: "black",translate:"translateX(1px)"}} />
        </div>
