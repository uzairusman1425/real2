  ...
  return (
    <div className='sticky top-0'>
      ...
      <div className='relative w-screen bg-[#f6f8f5]'>
        ...
        <div>
          <Image alt='' src={wave} width={Fullscreen} className='absolute -top-24 -z-10 min-w-[100vw] ' style={{transform:"scale(-1,1)",fill:"black",color: "black"}} />
          <Image alt='' src={wave2} width={Fullscreen} className='absolute -top-24 z-20 right-0 min-w-[100vw] ' style={{opacity:"0.4",fill:"black",color: "black",translate:"translateX(1000px)"}} />
          <Image alt='' src={wave2} width={Fullscreen} className='absolute -top-24 z-20 right-0 min-w-[100vw]  ' style={{opacity:"0.4",fill:"black",color: "black",translate:"translateX(1px)"}} />
        </div>
